...
export function NewClientOnboarding({ open, onClose, onComplete, editMode = false, initialData }: NewClientOnboardingProps) {
  ...
  const defaultFormData: ClientFormData = {
    ...
    contacts: [{ id: "1", name: "", email: "", countryCode: "+91", phone: "", whatsapp: false }],
    sameAsOffice: true,
    contactAddress: "",
  ...
  const addContact = () => {
    setFormData(prev => ({
      ...
      contacts: [
        ...prev.contacts,
        { id: Date.now().toString(), name: "", email: "", countryCode: "+91", phone: "", whatsapp: false }
      ]
    }))
  }
                    ...
                    <div>
                      ...
                      <label className="flex items-center gap-2 mt-2 cursor-pointer select-none">
                        <input
                          ...
                          onChange={(e) => updateContact(contact.id, 'whatsapp', e.target.checked)}
                          className="w-4 h-4 border-[#e5e5e5] dark:border-[#444] text-[#25D366] focus:ring-[#25D366] focus:ring-offset-0 accent-[#25D366] rounded"
                        />
                        ...
                        <span className="text-xs text-[#666] dark:text-[#999]">Available on WhatsApp</span>
                      </label>
                    </div>
                  </div>
                ))}
